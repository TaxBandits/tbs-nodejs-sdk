...
app.use('/Business', require('./routes/business/getBusinessRoute')) //Business/Get Routes
app.use('/Business', require('./routes/business/updateBusinessRoute')) //Business/Update Routes
