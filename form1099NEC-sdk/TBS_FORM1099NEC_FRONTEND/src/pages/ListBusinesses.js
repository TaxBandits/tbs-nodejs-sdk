...
const ListBusinesses = () => {
  ...
  // Navigate to create business by requesting create business API when no records found
            ...
            <>
              <div className='container mx-auto mt-5'>
                <div className="text-center">
                  <p>Before you create Form1099NEC in your TaxBandits account, you should have atleast one Business in your account. To add a new business, click 'Create Business' button below. </p>
                    ...
                    <>
                      <div className="response-table p-5">
                        <div className='d-flex align-items-center justify-content-between'>
                          ...
                          <button className='btn btn_primary btn_md float-right' onClick={navigateToCreateBusiness}>Create Business</button>
                        </div>
