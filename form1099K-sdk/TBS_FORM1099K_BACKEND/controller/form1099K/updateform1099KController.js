...
const updateForm1099K = async (req,res) => {
    ...
    try{
            ...
            const updateForm1099KResponse = await axios.put(`${process.env.TBS_PUBLIC_API_BASE_URL}/Form1099K/Update`,
                ...
                console.log("updateForm1099KResponse",updateForm1099KResponse);
             if(updateForm1099KResponse.statusCode=200){
                res.status(200).send([updateForm1099KResponse.data])
            }else{
                res.status(400).send(updateForm1099KResponse.data)
...
module.exports={updateForm1099K}