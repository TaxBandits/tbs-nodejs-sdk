...
const RequestPdfErrorModal = (pdfErrorData) => {
  ...
  return (
    ...
    <>
      <div class="modal fade" id="requestpdferrorModal" aria-hidden="true" aria-labelledby="requestpdferrorModal" tabindex="-1" >
        <div class="modal-dialog modal-dialog-centered modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="requestpdferrorModal">Error Response</h5>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="text-center align-top">
                        {pdfErrorData?.pdfErrorData?.Form1099MISCRecords?.ErrorRecords[0]?.RecordId}
                      </td>
                      <td class="text-center align-top">
                        {pdfErrorData?.pdfErrorData?.Form1099MISCRecords?.ErrorRecords[0]?.Status}
                      </td>
                      <td class="text-center border-radious-bottom-right align-top">
                        {pdfErrorData?.pdfErrorData?.Form1099MISCRecords?.ErrorRecords[0]?.Message}
                      </td>
                    </tr>
