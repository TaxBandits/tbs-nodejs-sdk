            ...
            <div className="modal-body">
              ...
              <div className='d-flex justify-content-between align-items-center p-3'>
                ...
                <div>
                  ...
                  <div className="text-dark fw-600 text-center mb-3">{statusData?.statusData?.PayerRef === null ? '-' : statusData?.statusData?.PayerRef}</div>
                </div>
              </div>
                    ...
                    <div class="mb-3 border-top px-4">
                      ...
                      <div class="pb-2 row">
                        <div class="col-4">
                          ...
                          <div class="fw-bold text-dark">{statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.FederalReturn?.Status}</div>
                        </div>
                        <div class="col-4">
                          <div class="form-label fw-500 text-muted mb-0">StatusTs</div>
                          <div class="fw-bold text-dark">{statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.FederalReturn?.StatusTs}</div>
                        </div>
                        <div class="col-4">
                          <div class="d-flex">
                            <div class="pe-3">
                              <div class="form-label fw-500 text-muted  mb-0">Info</div>
                              <div class="fw-bold text-dark">{statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.FederalReturn?.Info === null ? '-' : statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.FederalReturn?.Info}</div>
                            </div>
                          </div>
                        </div>
                  ...
                  <>
                    <div class="mb-3 border-top px-4">
                      ...
                      <div class="pb-2 row">
                        <div class="col-4">
                          <div class="form-label fw-500 text-muted  mb-0">Status</div>
                          <div class="fw-bold text-dark">{statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.Postal?.Status}</div>
                        </div>
                        <div class="col-4">
                          <div class="form-label fw-500 text-muted mb-0">StatusTs</div>
                          <div class="fw-bold text-dark">{statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.Postal?.StatusTs}</div>
                        </div>
                        <div class="col-4">
                          <div class="d-flex">
                            <div class="pe-3">
                              <div class="form-label fw-500 text-muted  mb-0">Info</div>
                              <div class="fw-bold text-dark">{statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.Postal?.Info === null ? '-' : statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.Postal?.Info}</div>
                            </div>
                          </div>
                        </div>
                  ...
                  <>
                    <div class="mb-3 border-top px-4">
                      ...
                      <div class="pb-2 row">
                        <div class="col-4">
                          <div class="form-label fw-500 text-muted  mb-0">Status</div>
                          <div class="fw-bold text-dark">{statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.OnlineAccess?.Status}</div>
                        </div>
                        <div class="col-4">
                          <div class="form-label fw-500 text-muted mb-0">Email</div>
                          <div class="fw-bold text-dark">{statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.OnlineAccess?.Email}</div>
                        </div>
                        <div class="col-4">
                          <div class="d-flex">
                            <div class="pe-3">
                              <div class="form-label fw-500 text-muted  mb-0">Info</div>
                              <div class="fw-bold text-dark">{statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.OnlineAccess?.Info}</div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="mb-3 border-top px-4">
                      ...
                      <div class="pb-2 row">
                        <div class="col-4">
                          ...
                          <div class="fw-bold text-dark">{statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.ScheduleFiling?.ScheduledOn === null ? '-' : statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.ScheduleFiling?.ScheduledOn}</div>
                        </div>
                        <div class="col-4">
                          <div class="form-label fw-500 text-muted mb-0">Info</div>
                          <div class="fw-bold text-dark">{statusData?.statusData?.Form1099Records?.SuccessRecords[0]?.ScheduleFiling?.Info}</div>
                        </div>
                      </div>
                    </div>
                  </>
