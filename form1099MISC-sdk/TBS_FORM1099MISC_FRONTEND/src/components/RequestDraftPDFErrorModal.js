...
const RequestDraftPDFErrorModal = (draftpdfErrorData) => {
  ...
  return (
    ...
    <>
      <div class="modal fade" id="draftpdfErrorModal" aria-hidden="true" aria-labelledby="draftpdfErrorModal" tabindex="-1" >
        <div class="modal-dialog modal-dialog-centered modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="draftpdfErrorModal">Error Response</h5>
