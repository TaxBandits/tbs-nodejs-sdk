            ...
            <>
              <div className='container mx-auto mt-5'>
                <div className="text-center">
                  <p>Before you create Form1099MISC in your TaxBandits account, you should have atleast one Business in your account. To add a new business, click 'Create Business' button below.</p>
                              ...
                              return (
                                <tr key={i}>
                                  ...
                                  <td className='text-center d-flex flex-row justify-content-center'>
                                    <Link className='btn btn-primary status-btn btn_smm me-2' to={`/createForm1099MISC/${businessDetail?.BusinessId}`}>Create MISC</Link>
                                    <Link className='btn btn-primary status-btn btn_smm me-2' to={`/listForm1099MISC/${businessDetail?.BusinessId}`}>List MISCs</Link>
                                  </td>
                                </tr>
                              )
                            })}
